...
import static com.sendbird.android.constant.StringSet.channel;

/**
 * Displays a list of Group Channels within a Sendbird application.
 */
class MyFriendListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//    private OnItemLongClickListener mItemLongClickListener;
    ...
    MyFriendListAdapter(Context context,List<GroupChannel> mChannelList) {
        mContext = context;
...
//    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((ChannelHolder) holder).bind(mContext, position, mChannelList.get(position));
    }
...
//            typingIndicatorContainer = (LinearLayout) itemView.findViewById(R.id.container_group_channel_list_typing_indicator);
        ...
        void bind(final Context context, int position, final GroupChannel channel) {
            ...
            topicText.setText(MainActivity.getGroupChannelTitle(channel)+channel);
